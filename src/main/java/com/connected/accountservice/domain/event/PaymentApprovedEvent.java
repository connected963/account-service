...
public class PaymentApprovedEvent {
    ...
    PaymentApprovedEvent(final UUID accountIdFrom,
    ...
    public boolean equals(Object o) {
        ...
        PaymentApprovedEvent that = (PaymentApprovedEvent) o;
    ...
    public String toString() {
        return new StringJoiner(", ", PaymentApprovedEvent.class.getSimpleName() + "[", "]")
